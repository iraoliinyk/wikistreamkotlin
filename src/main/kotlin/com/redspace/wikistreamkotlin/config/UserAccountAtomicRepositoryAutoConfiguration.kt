...
/**
 * Registers [UserAccountAtomicRepositoryImpl] as a bean only when a [CqlSession] is available.
 *
 * Declared as an autoconfiguration (after [CassandraAutoConfiguration]) so that the
