 ...
 * - Build a signed HS256 access token using Spring Security's [org.springframework.security.oauth2.jwt.JwtEncoder].
 ...
 * - Return token metadata to API callers via [com.redspace.wikistreamkotlin.consumer.controller.dto.TokenResponse].
 *
